              ...
              <div className={styles.width40Upper}>
                ...
                >
                  ...
                  <p style={{ textAlign: 'center', padding: '0', margin: '0' }}>
                    Многооборотные приводы АУМА используются, например, для
                    автоматизации задвижек или клапанов. Это наиболее
                    разнообразный продукт компании АУМА
                  </p>
                </div>
                <div
                  className={classNames(
          ...
          >
            <div className={styles.screenMiddle} style={{marginBottom: !isBigScreen ? '3rem' : ""}}>
              ...
              >
                ...
                <p style={{ textAlign: 'center', padding: '0', margin: '0' }}>
                  Неполнооборотные редукторы АУМА применяются, там, где для
              ...
              >
                ...
                <p style={{ textAlign: 'center', padding: '0', margin: '0' }}>
                  ...
                  цилиндрическими редукторами АУМА для увеличения крутящего
                  момента...
                </p>
              </div>
            </div>
