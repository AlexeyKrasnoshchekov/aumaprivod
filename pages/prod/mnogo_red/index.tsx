    ...
    <>
      ...
      <div className={styles.wrapper}>
        ...
        <p className={styles.text}>
          ...
          цилиндрическими редукторами AUMA для увеличения крутящего момента или
          для изменения положения выходного вала. Сами редукторы, разумеется,
          могут быть использованы для ручного управления арматурой.
        </p>
        ...
        <div className={styles.middleWrapper}>
          <div className={styles.left50}>
            ...
            <p className={styles.text}>
              ...
              сочетании с многооборотным редуктором GHT создают крутящий момент
              до 80000Нм.
            </p>
          </div>
          <div className={styles.right50}>
            ...
            />
            <p className={styles.text}>
              Для арматуры с ручным управлением может быть необходима информация
              о положении арматуры, которая отображается в диспетчерской. Это
              системы, где, например, клапан может находиться в открытом
              положении только тогда, когда другой клапан закрыт. Концевые
              выключатели WSH для арматуры, управляемой вручную, подходят именно
              для таких случаев.
            </p>
          </div>
        </div>
