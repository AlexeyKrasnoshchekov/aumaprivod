          ...
          <div className={styles.middleWrapper}>
            <div className={styles.left80}>
              ...
              <p className={styles.text}>
                ...
                валу привода, или направление смещено на 90 градусов,
                используются комбинации многооборотных приводов SA ... с
                цилиндрическими редукторами АУМА GST или коническими редукторами
                GK. В обоих случаях, выходной момент может быть увеличен в
                несколько раз.
              </p>
              <div
                style={{
