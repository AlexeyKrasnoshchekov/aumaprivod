  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Неполнооборотные редукторы АУМА применяются, там, где для работы
      ...
      <div className={styles.wrapper}>
        ...
        <p className={styles.text}>
          Неполнооборотные редукторы АУМА применяются, там, где для работы
          арматуры необходим поворот рабочего органа на 90°.
        </p>
        <p className={styles.text}>
        ...
        <div className={styles.middleWrapper}>
          ...
          <Link href={'/prod/nepoln_red/1'}><h2 className={styles.title}>Червячные редукторы GS</h2></Link>
            ...
            />
            <p className={styles.text}>
              Червячные редукторы АУМА используются для управления
