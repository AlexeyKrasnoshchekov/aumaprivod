...
const imagesCarouselLarge = [
  '/images/automatisation_large.jpg',
  '/images/prom_use_large.jpg',
  '/images/oil_gas_large.jpg',
  '/images/regul_large.jpg',
  '/images/temperature_large.jpg',
];
      ...
      <div className={cn(className, styles.bodyWrapper)} {...props}>
        ...
        <div className={styles.bodyCenter}>
          <Carousel
            ...
            swipeable={false}
          >
            {imagesCarouselLarge.map((URL, index) => (
...
export async function getStaticProps() {
  ...
  const filteredSales = objectData.posts.filter(
    (post: any) => post.type === 'sales'
  );
